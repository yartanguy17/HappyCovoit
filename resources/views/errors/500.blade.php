        ...
        <div class="text-center">
            ...
            <div class="lockscreen-wrapper">
                <div class="lockscreen-logo">
                    <a style="color: white;font-size: 30px" href="/" class="text-uppercase"><b>H.T.W <br><br>
                        Oups, La Connexion a été perdue
                        </b>
                    </a>
                </div>
                <!-- User name -->
                <div class="lockscreen-name h2"><strong style="color: white">Happy Travel World</strong> </div><br>
                ...
                <div class="lockscreen-item">
                    ...
                    <form class="lockscreen-credentials" >
                        <div class="input-group" style="margin-left:30px;">
                            <input class="form-control" type="text" placeholder="Erreur 500">
               ...
               <!-- <div class="help-block text-center" style="color: white">
                    <h4 class="text-uppercase">Desolé, La page à laquelle vous éssayez d'accéder n'est plus accessible, <br>Revérifier votre saisie connexion.</h4>
                </div>-->
                <hr class="divider">
