<div role="tabpanel" class="tab-pane" id="voyages-particulier">
          ...
          <tbody>
           ...
           <tr style="<?= ($reservation->is_signal==1)?'background-color: #F08080;color:white;':''?>">
            ...
            <td>
              ...
              @else
              {{ getLigneById($reservation->ligne_destination_id)->ville_destination}}, {{ getLigneById($reservation->ligne_destination_id)->pays_destination}}
              @endif
