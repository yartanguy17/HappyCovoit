@extends("layouts.base_compagnie") @section('title') Modifier une ligne @endsection @section('content')
...
<div class="page-body">
    <div class="card">
        ...
        <div class="card-block">
            <form action="/user-compagnie/edit-ligne-depart/{{ $ligneDepart->id }}" method="post">
               {{ csrf_field() }}
                <div class="m-b-20">
    ...
    href="/user-compagnie/lignes-depart/{{ $ligneDepart->destination->id }}">
