@extends("layouts.base_compagnie") @section('title') Tous les Abonnés @endsection
@section('top_script') 
@endsection
    ...
    <div class="col-lg-4">
      <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
          ...
          <li class="breadcrumb-item"><a href="#!">Tous les Abonnés</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="card">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="/user-compagnie/send-message-abonnes" method="post">
      ...
      <div class="dt-responsive table-responsive">
        <table id="simpletable" class="table table-striped table-hover table-bordered nowrap">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ getUserNameById($abonne->client->id) }}</td>
             <td>{{ $abonne->client->telephone}}</td>
             <td>{{ getAllVoyageurDepartCompagnieCount($abonne->client->id,getUserAuth()->id) }}</td>
             <td>
            <button type="button" class="btn btn-success" data-toggle="modal"
            data-target="#sendCard{{$abonne->client->id}}">
            <i class="feather icon-share"></i>
          </button>
        </td>
           </tr>
           <div class="modal fade" id="sendCard{{$abonne->client->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="/user-compagnie/send-message-abonnes/{{$abonne->client->id}}" method="post">
              {{ csrf_field() }}
              <div class="modal-body">
               <div class="row">
                <div class="col-lg-12">
