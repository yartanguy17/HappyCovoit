@extends("layouts.base_compagnie") @section('title') Modifier son mot de passe @endsection @section('content')
...
<div class="page-body">
  <div class="card">
    ...
    <div class="card-block">
      <form action="/user-compagnie/change-password" method="post">
       {{ csrf_field() }}
       <div class="m-b-20">
