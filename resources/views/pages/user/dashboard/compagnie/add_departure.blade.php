@extends("layouts.base_compagnie") @section('title') Ajouter un depart @endsection @section('content')
...
<div class="page-body">
    <div class="card">
        ...
        <div class="card-block">
            <form action="/user-compagnie/add-depart" method="post">
               {{ csrf_field() }}
                <div class="m-b-20">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                        <label class="col-sm-8 col-form-label">Date de départ</label>
                            <div class="col-sm-8 col-lg-10">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="icofont icofont-shield"></i></span>
