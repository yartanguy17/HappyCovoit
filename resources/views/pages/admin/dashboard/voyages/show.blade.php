@extends("layouts.base_admin") @section('title') Tous les Départs @endsection
@section('top_script') 
@endsection
...
<div class="page-body">
  <div class="card">
    ...
    <div class="card-block">
          ...
          <tbody>
            ...
            <tr>
             ...
             <td>
              ...
              href="/admin/edit-depart/{{$destination->id}}">
      ...
      href="/admin/lignes-depart/{{$destination->id}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/admin/add-ligne-depart/{{ $destination->id }}" method="post">
       {{ csrf_field() }}
       <div class="m-b-20">
        <div class="row">
          <div class="col-lg-6">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer bg-whitesmoke br">
          <a href="/admin/delete-depart/{{$destination->id}}"
