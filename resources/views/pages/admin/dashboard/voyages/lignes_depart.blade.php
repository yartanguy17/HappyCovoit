@extends("layouts.base_admin") @section('title') Toutes les lignes du départ {{ $destination->pays_demarrage }}, {{ $destination->ville_demarrage }} - {{ $destination->pays_destination }}, {{ $destination->ville_destination }} @endsection
@section('top_script') 
@endsection
          ...
          <tbody>
           ...
           <tr>
             ...
             <td>
              ...
              href="/admin/edit-ligne-depart/{{$ligne->id}}">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer bg-whitesmoke br">
              <a href="/admin/delete-ligne-depart/{{$ligne->id}}"
