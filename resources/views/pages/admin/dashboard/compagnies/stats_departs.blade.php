@extends("layouts.base_admin") @section('title') Départ :: {{ $destination->pays_demarrage }}, {{ $destination->ville_demarrage }} - {{ $destination->pays_destination }}, {{ $destination->ville_destination }} @endsection
@section('top_script') 
@endsection
          ...
          <div class="dt-responsive table-responsive">
            <table id="my-table" class="table table-striped table-hover table-bordered nowrap">
              ...
              <tbody>
               ...
               <td>{{ getNbreReservationsAll($destination->id, $reservation['date_depart']) }}</td>
               <td>
                <form action="/admin/compagnie/stats-departs-details" method="post">
                  {{ csrf_field() }}
