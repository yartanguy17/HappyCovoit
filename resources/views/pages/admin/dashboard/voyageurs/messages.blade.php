@extends("layouts.base_admin") @section('title') Messages des Voyageurs @endsection
@section('top_script') 
    ...
    <div class="col-lg-4">
      <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
          ...
          <li class="breadcrumb-item"><a href="#!">Messages des Voyageurs</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <table id="simpletable" class="table table-striped table-hover table-bordered nowrap">
          ...
          <tbody>
           ...
           <tr>
            ...
            <td>@if($message->status == 0)<button type="button" class="btn btn-info" data-toggle="modal"
